...
const MovieCard = ({movie}) => {
  ...
  return (
   movie.poster_path && <div className='w-52 px-2 flex-none mx-1 cursor-pointer hover:translate-x-2 hover:-translate-y-2' onClick={()=>dispatch(toggleMoviePopup({id:movie.id,isPopup:true}))}>
